...
public fun ReleaseNotesScreen() {
    ...
    val state by produceState<ReleaseNotesUiState>(
        ...
        value =
            when (val result = checker.releaseNotesFor(BuildConfig.VERSION_NAME)) {
