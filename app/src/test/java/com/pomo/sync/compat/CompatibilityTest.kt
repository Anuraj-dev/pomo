...
public class CompatibilityTest {
    ...
    private val current = CompatibilityProfile("full", setOf(1, 2), setOf(2), setOf(2), setOf(2), setOf(2), setOf(2), 6, true)
    @Test public fun deviceReadyRequiresTheCompleteAuthenticatedBaseline() {
    ...
    @Test public fun readerFirstActivationNeedsIndependentConfirmationAndQuarantinesConcurrency() {
    ...
    @Test public fun oldBuildsAreReadOnlyAndIndependentFactsNeedImport() {
